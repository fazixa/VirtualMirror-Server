...
def foundation_worker(w_frame, r, g, b, intensity, k_h, k_w, out_queue) -> None:
    result = Globals.face_foundation.apply_foundation(
        w_frame,
    ...
    out_queue.append({
        'index': 0,
        'image': result,
        'range': (Globals.face_foundation.x_all, Globals.face_foundation.y_all)
    })
...
Globals.makeup_workers = {
    'foundation_worker':    { 'function': foundation_worker,    'args': [], 'enabled': False, 'enabled2': False},
...
def apply_makeup_video():
    ...
    while True:
        ...
        for face in detected_faces:
            ...
            if Globals.makeup_workers['foundation_worker']['enabled2']:
                ...
                cropped_img = Globals.foundation.apply_foundation(
                    cropped_img,
                    landmarks_x_81, landmarks_y_81,
                    landmarks_x_68, landmarks_y_68,
                    255, 253, 208, 81, 81, 1
                )
...
def enable_makeup(makeup_type='', r=0, g=0, b=0, intensity=.7, lipstick_type='hard', gloss=False, k_h=81, k_w=81):
    if makeup_type == 'eyeshadow':
        ...
        Globals.makeup_workers['foundation_worker']['enabled2'] = True
...
def disable_makeup(makeup_type):
    if makeup_type == 'eyeshadow':
        ...
        Globals.makeup_workers['foundation_worker']['enabled2'] = False
    elif makeup_type == 'eyeliner':
